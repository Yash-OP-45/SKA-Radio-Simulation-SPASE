...
def plot_spectrum(csv_file1, csv_file2, output_file):
    ...
    convert_delimiter(csv_file1, temp_csv_file1)
    ...
    plt.title(' S4_Oxidation Pond_High_and_Low_3', fontsize=16)
...
csv_file1 = r'D:\Project-Simulation of the nightsky\TinySA\Spectrometric Analysis\S4\tinysa_2024-07-08_17-30-23-L-S4-3.csv'
csv_file2 = r'D:\Project-Simulation of the nightsky\TinySA\Spectrometric Analysis\S4\tinysa_2024-07-08_17-31-46-H-S4-3.csv'
output_image = r'D:\Project-Simulation of the nightsky\TinySA\Combined_Spectrum_plots\S4_3'
